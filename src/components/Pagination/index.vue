<template>
    <div class="pagination">
        ...
        <button v-if="startAndEndNum.start >= 2" @click="$emit('getPageNo', 1)">1</button>
        ...
        <button v-if="startAndEndNum.end < totalPage" @click="$emit('getPageNo', totalPage)">{{ totalPage }}</button>
