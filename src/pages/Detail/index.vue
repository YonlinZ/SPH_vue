    ...
    <section class="con">
      ...
      <div class="mainCon">
        ...
        <div class="previewWrap">
          <!--放大镜效果-->
          <Zoom :skuImageList="this.skuImageList" />
          <!-- 小图列表 -->
          <ImageList :skuImageList="this.skuImageList" />
        </div>
        <!-- 右侧选择区域布局 -->
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(spuSaleAttr, indexx) in spuSaleAttrList" :key="spuSaleAttr.id">
...
export default {
  ...
  methods: {
    ...
    changeSkuNum(event) {
      var input = event.target.value * 1;
      if (input && input < 1) {
        this.skuNum = 1;
      }
    },
